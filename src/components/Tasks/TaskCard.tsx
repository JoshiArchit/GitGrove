...
const TaskCard = ({ workItemId, task }: TaskCardProps) => {
  ...
  return (
    <>
      <div
        className="rounded-lg border-2 border-l-6 border-gray-400 border-l-amber-400 px-2 py-1 text-white hover:cursor-pointer hover:border-black hover:bg-amber-100 hover:text-black"
        onClick={openDialog}
      >
        {task.title}
      </div>
